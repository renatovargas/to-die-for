# 03_Exercise.R
# 
# Estimate direct and indirect responsibilities for 
# fatal injuries at the workplace in all regions
...
years <-as.character(c(2003:2008))
years[2]
# 	=====================================
...
#	=====================================
# 	3. Exercise - Occupational injuries
#	=====================================
...
fdresAY <- cbind(fdres2003, fdres2004, fdres2005, fdres2006, fdres2007, fdres2008)
colnames(fdresAY) <- as.character(c(2003:2008))
write.csv(fdresAY, file = paste(getwd(),"/results/EX",ex[1],"_findemAllYrs.csv", sep=""))

prodresAY <- cbind(prodres2003, prodres2004, prodres2005, prodres2006, prodres2007, prodres2008)
colnames(prodresAY) <- as.character(c(2003:2008))
